...
<script>
import BooksForm from '../../components/admin/BooksForm.vue';

export default {
    middleware : ["check-auth", "auth"],
    layout: 'plain',
    components: { BooksForm }
}
</script>
<style>
...
<!-- <template>
  <div>
    <div class="background pb-5 pt-3">
      <h1 class="text-center text-dark fw-bold pt-5 pb-4">Add New Product</h1>
      <form class="row g-3 needs-validation d-relative mx-auto w-50 d-flex" novalidate>
        ...
        <button class="btn btn-success fw-bold" @click.prevent="addNewBooksData">S u b m i t</button>
      </form>
      {{ newProductItem }}
    </div>
  </div>
