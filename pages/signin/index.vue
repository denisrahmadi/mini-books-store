<template>
  <div>
    <div>
      <main class="form-signin w-50 mx-auto px-3 py-5">
        <h1 class="text-center mb-5"><span class="bg-white px-5 py-1">Form Signin</span></h1>
        <form @submit.prevent="signIn">
          ...
          <p class="mt-1">
            Dont have any account?
              <span><nuxt-link to="/signup" class="text-decoration-none text-info">signup</nuxt-link></span>
          </p>
        </form>
      </main>
    </div>
